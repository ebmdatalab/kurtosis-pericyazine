...
pericyazine_results_by_region.to_csv( 'pericyazine_results_by_region.csv' )
...
pericyazine_results_eastengland.to_csv( 'pericyazine_results_eastengland_region.csv' )
...
promazine_results_by_region.to_csv( 'promazine_results_by_region.csv' )
...
promazine_results_northwest.to_csv( 'promazine_results_northwest_region.csv' )
